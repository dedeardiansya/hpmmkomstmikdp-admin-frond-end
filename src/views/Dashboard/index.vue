    ...
    >
      <div class="kt-portlet__head kt-portlet__space-x">
        <div class="kt-portlet__head-label">
          <h3 class="kt-portlet__head-title">Data pengunjung</h3>
        </div>
        <div class="kt-portlet__head-toolbar">
          <a href="#" class="btn btn-label-primary btn-sm btn-bold">Refresh</a>
        </div>
      </div>
      <div class="kt-portlet__body kt-portlet__body--fluid">
        <div class="kt-widget20">
          ...
          <div class="kt-widget20__chart" style="height:130px;">
            ...
            <canvas
              ref="kt_chart_bandwidth1"
              width="1034"
              height="130"
              class="chartjs-render-monitor"
              style="display: block; width: 1034px; height: 130px;"
            ></canvas>
          </div>
        </div>
      </div>
...
export default {
  mounted() {
    ...
    var ctx = this.$refs.kt_chart_bandwidth1.getContext('2d')
        ...
        datasets: [
          {
            ...
            pointBorderColor: Chart.helpers
              ...
              .alpha(0)
              .rgbString(),
            pointHoverBackgroundColor: state.danger,
            ...
            fill: 'start',
            data: [10, 14, 12, 16, 9, 11, 10, 9, 13, 15, 5, 10]
          }
        ]
      },
      options: {
